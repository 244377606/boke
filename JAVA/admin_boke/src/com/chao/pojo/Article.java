...
public class Article {
 ...
 private String articleLastTime; /* 最后修改时间 */ 
 
 private Integer pageView;    /* 浏览量 */
 private Integer critiques;   /* 评论次数 */
 private String articleType;  /* 文章类型 */
 
 private String oldImg;  /* 原图片 */
 
 
 
public String getArticleLastTime() {
	return articleLastTime;
}
public void setArticleLastTime(String articleLastTime) {
...
public String toString() {
	return "Article [articleId=" + articleId + ", title=" + title + ", author=" + author + ", content=" + content
			...
			+ ", articleType=" + articleType + ", oldImg=" + oldImg + "]";
}
