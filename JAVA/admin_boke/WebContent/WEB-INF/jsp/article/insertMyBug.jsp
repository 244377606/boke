	 ...
	 <form class="layui-form layui-form-pane" action="">
		 ...
		 <div class="layui-form-item layui-form-text username">
			    ...
			    <div class="layui-input-block">
			      <textarea id="bugError" name="bugError" class="layui-textarea" style="height:150px;"></textarea>
			    </div>
		  </div>
		  ...
		  <div class="layui-form-item layui-form-text username">
			    ...
			    <div class="layui-input-block">
			      <textarea id="bugReason" name="bugReason" class="layui-textarea" style="height:100px;"></textarea>
			    </div>
		  </div>
		  ...
		  <div class="layui-form-item layui-form-text username">
			    ...
			    <div class="layui-input-block">
			      <textarea id="bugSolve" name="bugSolve" class="layui-textarea" style="height:100px;"></textarea>
			    </div>
		  </div>
	  ...
	  <script type="text/javascript">
	  	$("#ralSummit").on("click",function(){
 			$.ajax({
	  			type:"post",
	  			url:"${pageContext.request.contextPath}/insertMyBugInfo",
	  			data:{
