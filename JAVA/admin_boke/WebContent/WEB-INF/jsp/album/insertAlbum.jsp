	 ...
	 <form class="layui-form layui-form-pane" action="">
		 ...
		 <div class="username" >
		    ...
		    <div class="layui-input-block">
		      <input type="text" id="albumTitle" lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		 </div>
		 ...
		 <div class="username" >
		    ...
		    <div class="layui-input-inline">
		      <input type="text" id="albumType" lay-verify="required" autocomplete="off" class="layui-input">
		    </div>
		 </div>
		 
		 <div class="layui-upload username">
			  <button type="button" class="layui-btn" id="updateImg">上传封面</button>
	  ...
	  <script type="text/javascript">
	  	...
	  	function t(){
  			...
  			if($("#newImg").val()){
  				$.ajax({
		  			type:"post",
		  			url:"${pageContext.request.contextPath}/insertAlbumInfo",
		  			data:{
